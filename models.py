...
class BotSettings(Base):
    ...
    groq_api_key_encrypted: Mapped[str] = mapped_column(Text, default="")
    preferred_ai_provider: Mapped[str] = mapped_column(String(16), default="gemini")
    gemini_model: Mapped[str] = mapped_column(String(80), default="")
    deepseek_model: Mapped[str] = mapped_column(String(80), default="")
    openai_model: Mapped[str] = mapped_column(String(80), default="")
    groq_model: Mapped[str] = mapped_column(String(80), default="")
