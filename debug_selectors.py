#!/usr/bin/env python3
"""
Interactive selector debugger for the current Drips Wave UI.
"""
...
def debug():
    storage = SESSION_DIR / "drips.json"
    ...
    with sync_playwright() as pw:
        ...
        if links:
            ...
            if first_href:
                issue_url = first_href if first_href.startswith("http") else f"https://www.drips.network{first_href}"
                page.goto(issue_url)
